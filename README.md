...
`androidFirebaseInstallationId: true` is an opt-in for the Firebase Installation ID (FID) registration path. It only writes the manifest flag; the rest of the setup is owned by your app:
