...
export interface Props {
    ...
    loggingFunction: (message: string, optionalArg?: object | string) => void;
    ...
    createNotificationFields() {
        ...
        const removeNotificationButton = renderButtonView(
            ...
            () => {
                ...
                loggingFunction("Removing notification with id:", String(number));
        ...
        const getTriggerValueForKeyButton = renderButtonView(
            ...
            async () => {
                try {
                    ...
                    loggingFunction(`Trigger value for key ${key}: `, String(value));
                } catch (e) {
                  let message;
                  if (e instanceof Error) message = e.message;
                  else message = String(e);
                  loggingFunction("Error getting trigger value: ", message);
                }
            }
        )
    ...
    createOutcomeFields() {
        ...
        const sendOutcomeWithValueButton = renderButtonView(
            ...
            () => {
                ...
                loggingFunction("Sending outcome of name 'my_outcome' with value: ", String(value));
