...
const GREETING_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'Welcome to Nike!', largeIcon: buildIconUrl('human-greeting-red.png') },
  { heading: '', content: 'Welcome to Adidas!', largeIcon: buildIconUrl('human-greeting-red.png') },
  { heading: '', content: "Welcome to Sandra's cooking blog!", largeIcon: buildIconUrl('human-greeting-red.png') },
];

const PROMOTION_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'Get 20% off site-wide!', largeIcon: buildIconUrl('brightness-percent-red.png') },
  { heading: '', content: 'Half-off all shoes today only!', largeIcon: buildIconUrl('brightness-percent-red.png') },
  { heading: '', content: '3 hour flash sale!', largeIcon: buildIconUrl('brightness-percent-red.png') },
];
...
const ABANDONED_CART_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'You have some shoes left in your cart!', largeIcon: buildIconUrl('cart-red.png') },
  { heading: '', content: 'Still want to buy the dress you saw?', largeIcon: buildIconUrl('cart-red.png') },
  { heading: '', content: '20% off the shoes you saw today.', largeIcon: buildIconUrl('cart-red.png') },
];

const NEW_POST_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'I just published a new blog post!', largeIcon: buildIconUrl('image-red.png') },
  { heading: '', content: 'Come check out my new blog post on aliens!', largeIcon: buildIconUrl('image-red.png') },
  { heading: '', content: '10 places you have to see before you die.', largeIcon: buildIconUrl('image-red.png') },
];

const RE_ENGAGEMENT_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'Your friend George just joined Facebook', largeIcon: buildIconUrl('gesture-tap-red.png') },
  { heading: '', content: 'Can you beat level 23?', largeIcon: buildIconUrl('gesture-tap-red.png') },
  { heading: '', content: 'Check out our Fall collection!', largeIcon: buildIconUrl('gesture-tap-red.png') },
];

const RATING_VARIATIONS: NotificationPayload[] = [
  { heading: '', content: 'How was your food/experience at Chipotle?', largeIcon: buildIconUrl('star-red.png') },
  { heading: '', content: 'Rate your experience with Amazon.', largeIcon: buildIconUrl('star-red.png') },
  { heading: '', content: 'Let your Lyft driver know how the ride was.', largeIcon: buildIconUrl('star-red.png') },
];

export const NotificationTemplates: NotificationTemplate[] = [
  { id: 'GENERAL', title: 'General', icon: '🔔', variations: GENERAL_VARIATIONS },
  { id: 'GREETINGS', title: 'Greetings', icon: '👋', variations: GREETING_VARIATIONS },
  { id: 'PROMOTIONS', title: 'Promotions', icon: '💰', variations: PROMOTION_VARIATIONS },
  { id: 'BREAKING_NEWS', title: 'Breaking News', icon: '📰', variations: BREAKING_NEWS_VARIATIONS },
  { id: 'ABANDONED_CART', title: 'Abandoned Cart', icon: '🛒', variations: ABANDONED_CART_VARIATIONS },
  { id: 'NEW_POST', title: 'New Post', icon: '📝', variations: NEW_POST_VARIATIONS },
  { id: 'RE_ENGAGEMENT', title: 'Re-Engagement', icon: '🎯', variations: RE_ENGAGEMENT_VARIATIONS },
  { id: 'RATING', title: 'Rating', icon: '⭐', variations: RATING_VARIATIONS },
];
