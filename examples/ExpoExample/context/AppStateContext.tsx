...
function appStateReducer(state: AppState, action: AppAction): AppState {
  switch (action.type) {
    ...
    case 'REMOVE_ALIAS':
      return { ...state, aliases: state.aliases.filter((a) => a.key !== action.payload) };
    ...
    case 'REMOVE_TAG':
      return { ...state, tags: state.tags.filter((t) => t.key !== action.payload) };
    case 'SET_ALL_TAGS':
      return { ...state, tags: action.payload };
    case 'ADD_TRIGGER':
      return { ...state, triggers: [...state.triggers, action.payload] };
    case 'REMOVE_TRIGGER':
      return { ...state, triggers: state.triggers.filter((t) => t.key !== action.payload) };
    ...
    case 'ADD_SMS':
      return { ...state, smsNumbers: [...state.smsNumbers, action.payload] };
    case 'REMOVE_SMS':
      return { ...state, smsNumbers: state.smsNumbers.filter((s) => s !== action.payload) };
    case 'SET_ALL_SMS':
      return { ...state, smsNumbers: action.payload };
    case 'SET_PUSH_SUBSCRIPTION_ID':
      return { ...state, pushSubscriptionId: action.payload };
    case 'SET_PUSH_ENABLED':
      return { ...state, pushEnabled: action.payload };
    case 'SET_IAM_PAUSED':
      return { ...state, iamPaused: action.payload };
