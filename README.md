...
| `appGroupName`           | optional | Used to configure a custom app group name. It will be injected as `group.{appGroupName}.oneSignal`. If unused, the plugin will use the value of `group.{ios.bundleIdentifier}.onesignal`. |
