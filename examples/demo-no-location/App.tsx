    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.headerSafeArea}>
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Expo No-Location Demo</Text>
        </View>
      </SafeAreaView>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.card}>
            <Text style={styles.body}>
              This demo initializes OneSignal and requests notification permission without using
              location. Native build configuration excludes the OneSignal location module.
            </Text>
